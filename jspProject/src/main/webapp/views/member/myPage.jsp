    ...
    <div class="outer">
        ...
        <form action="<%=contextPath%>/update.me" id="mypage-form" method="post">
            ...
            <div align = "center">
                ...
                <button type="button" class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#updatePwdModal">비밀번호변경</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" align="center">
                    <form action="<%=contextPath %>/updatePwd.me" method="post">
                        ...
                        <br>
                        <button id="editPwdBtn" type="submit" class="btn btn-sm btn-secondary" onclick="return checkPwd2()">비밀번호 변경</button>
                    </form>
                    <script>
                        document.getElementById("editPwdBtn").onclick = function(){
                            let updatePwd = document.querySelector("input[name=updatePwd]");
